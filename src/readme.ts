// TODO: use ejs to generate readme

export const getSelfIntro = (): string => {
  const selfIntro = `
...
export const getWkldleStyle = (): string => {
  const style = `
  <style>
  .wrapper {
  display: flex;
...
export const getInitWkldleText = (): string => {
  const initWkldleText = `
<div class="wrapper">
  <div class="board">
    <div class="row">
      <div class="item">!</div>
